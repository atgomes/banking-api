...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("BankingAPI");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("BankingAPI");
        ...
        config.getMapConfigs().put("com.github.atgomes.service.bankingapi.domain.*", initializeDomainMapConfig(jHipsterProperties));
